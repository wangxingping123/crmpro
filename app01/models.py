...
class ClassList(models.Model):
    ...
    teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo', related_name='teach_classes',limit_choices_to={"depart":10003})
    tutor = models.ForeignKey(verbose_name='班主任', to='UserInfo', related_name='classes',limit_choices_to={"depart":10002})
...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', related_name='consultant',limit_choices_to={'depart_id':10001})
...
class CustomerDistribution(models.Model):
    ...
    客户分配表
    """
    user = models.ForeignKey(verbose_name='客户顾问',to='UserInfo',related_name='cds',limit_choices_to={'depart_id':10001})
...
class SaleRank(models.Model):
    ...
    销售权重和数量
    """
    user = models.ForeignKey(to="UserInfo",limit_choices_to={'depart_id':10001})
...
class CourseRecord(models.Model):
    ...
    teacher = models.ForeignKey(verbose_name="讲师", to='UserInfo',limit_choices_to={"depart":10003})
